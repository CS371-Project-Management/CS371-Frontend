...
import { ClassTypesUpdate } from "@/types/classTypes";
...
export default function ModalEditClassroom({ isOpen, onClose, cls }: ModalProps) {
    ...
    const handleSave = async () => {
        const newErrors: { classroomName?: string; description?: string } = {};
        ...
        try {
            await ClassService.updateClass(cls.id, req);
    ...
    return (
        <>
            ...
            <ReportFail
                ...
                title="Failed to edit classroom."
                press="OK"
            />
        </>
    );
